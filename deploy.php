...
// @todo configure this project repository
set('blog', 'https://github.com/Shinelia/blog');

// hosts @todo configure this
host('audrey-dev.fr')
    ->stage('prod')
...
task('clean:git-files', function () {
    run('rm -fr ~/{{projects_dir}}/{{application}}/current/.git'); //supprssion du dossier .git inutile en prod
});
